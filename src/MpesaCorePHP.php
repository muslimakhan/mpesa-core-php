...
namespace MuslimAKhan\MpesaCorePHP;

/**
 * Class MpesaCorePHP
 * @package MuslimAKhan\MpesaCorePHP
 */
class MpesaCorePHP {

    private static $MPESA_ENV;
    private static $MPESA_CONSUMER_KEY;
    private static $MPESA_CONSUMER_SECRET;

    public function __construct($config) {
        if (is_array($config) && isset($config['MPESA_ENV']))
            static::$MPESA_ENV = $config['MPESA_ENV'];
        if (is_array($config) && isset($config['MPESA_CONSUMER_KEY']))
            static::$MPESA_CONSUMER_KEY = $config['MPESA_CONSUMER_KEY'];
        if (is_array($config) && isset($config['MPESA_CONSUMER_SECRET']))
            static::$MPESA_CONSUMER_SECRET = $config['MPESA_CONSUMER_SECRET'];
    }
    ...
    public static function generateLiveToken() {
        ...
        $consumer_key = static::$MPESA_CONSUMER_KEY;
        $consumer_secret = static::$MPESA_CONSUMER_SECRET;
